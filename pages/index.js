             ...
             <table style={{minWidth:1020}} >
               ...
               <tbody >
                {paged.map((t,i) =>{
                  ...
                  const notional = t.notional_usd ? '$'+Math.round(t.notional_usd).toLocaleString() : '—'
                  ...
                  return (
                     <tr key={t.id||i} className= "clk " onClick={() =>setSelected(t)} >
                       ...
                       <td className="private" style={{fontFamily:'var(--font-mono)',fontSize:11}}>{notional}</td>
...
.sub { colo r: #6b7280; font-size: 12px; margin-bottom: 24px; }
...
.meta-val { font-size: 18px; font-we ight: 700; color: #1a56db; }
...
.ed ge-win { background: #ecfdf5; border: 1px solid #a7f3d0; }
.edge-los { background: #fef2f2; border: 1px solid #fecaca; }
.edge-lbl { font-size: 10px; font-weight: 700; text-transfo rm: uppercase; letter-spacing: .06em; margin-bottom: 4px; }
.tip { padding: 12px 16px; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; margin-bottom: 24px; }
.t ip-lbl { font-size: 10px; font-weight: 700; color: #1e429f; text-transform: uppercase; letter-spacing: .06em; margin-bottom: 4px; }
...
.ins-tag { display: inline-block; padding: 2px 8px; bor der-radius: 4px; font-size: 10px; font-weight: 700; margin-bottom: 8px; color: #fff; }
