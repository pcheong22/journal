          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(110px,1fr))',gap:8,marginBottom:16}}>
            ...
            <div style={{background:'var(--sf2)',border:'1px solid var(--bd)',borderRadius:7,padding:'10px 12px',position:'relative'}}>
              ...
              {showNotionalTip && notionalTooltip && (
                <div style={{position:'absolute',bottom:'calc(100% + 6px)',left:0,zIndex:100,background:'var(--sf)',border:'1px solid var(--bd)',borderRadius:7,padding:'10px 12px',boxShadow:'var(--sh-lg)',minWidth:260,maxWidth:320}}>
